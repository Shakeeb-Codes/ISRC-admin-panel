...
export default function Sidebar() {
  ...
  const handleLogout = () => {
    // TODO: Add logout logic when authentication is implemented
  ...
  return (
    <div className="w-64 bg-[#009cd6] text-white flex flex-col h-screen sticky top-0">
      ...
      <Link
        ...
        className="p-6 flex items-center justify-center gap-3 border-b border-gray-700 hover:bg-gray-700 transition-colors"
      >
